public class Constants {
    ...
    public static final String PASSENGER_RANGE_ID_MIN = "1", PASSENGER_RANGE_ID_MAX = "891";

    public static final int PASSENGER_ID = 0, PASSENGER_SURVIVED = 1, PASSENGER_P_CLASS = 2,
